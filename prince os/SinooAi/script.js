...
const GOOGLE_API_KEY = "AIzaSyCga209d4Tf_W4Ov1TGH8Wr5itSJCNi5UM";
const API_REQUEST_URL = `https://generativelanguage.googleapis.com/v1/models/gemini-2.5-pro:generateContent?key=${GOOGLE_API_KEY}`;
...
const loadSavedChatHistory = () => {
    ...
    savedConversations.forEach(conversation => {
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/logo.png" alt="Sinoo Logo">
